                  ...
                  {items.map((item) => (
                    <div key={item.id} className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {item.variantName && (
                          <div className="text-xs text-graphite">{item.variantName}</div>
                        )}
            ...
            {items.length > 0 && (
              <div className="border-t border-line px-6 py-5 dark:border-white/10">
                ...
                <Link
                  href="/checkout"
                  onClick={closeCart}
                  className="flex w-full items-center justify-center gap-2 rounded-xl2 bg-ink py-3.5 text-sm font-semibold text-white transition hover:bg-navy dark:bg-white dark:text-ink"
                >
